...
// Compile-time registration of every known App -- Phase 3 registers the
// first real vertical (Restaurant) here. This is the one narrow,
// intentional exception to App Registry's otherwise zero-dependency status
// (see docs/phases/PHASE_2_PLAN.md §5): a registration mechanism inherently
