...
**Reserved for later phases:** Roles & Permissions beyond the bare `'Owner'` special-case (no capability matrix yet), the Inventory Engine, the Order Engine, Audit Logs, and Notifications — see `docs/ROADMAP.md`.
